...
export default function HabitsPage() {
  ...
  const toggleCompletion = (habitId: string, dateStr: string) => {
    // playWaterDropSound(); // Removed to prevent continuous sound
        ...
        <div className="relative z-10 p-4 sm:p-6 md:p-8">
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
              <div>
                <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 bg-clip-text text-transparent mb-2">
                  Habit Tracker
                </h1>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-white">{getCompletionRate()}%</p>
                  </div>
                </div>
              </motion.div>
